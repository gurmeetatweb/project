...
def main():
    ...
    st.sidebar.info(
        """
        Hackathon Initiative by ![image](https://cdn.masaischool.com/masai-website/Masai_Logo_dark_web_ezgif_com_png_to_webp_converter_39513d2c2c.webp)
    ...
    st.sidebar.subheader("Application Hosting")
    try:
        image_path = "./image/qrcode.png"
        developer_img = Image.open(image_path)
        st.sidebar.image(developer_img, width=200)
    except FileNotFoundError:
        st.sidebar.image("https://via.placeholder.com/200", width=200)    
